...
import { Building2, Target, Eye, Heart, User, Calendar, Banknote, Scale } from 'lucide-react';
                    ...
                    <div className="space-y-8">
                        ...
                        <Reveal delay={100}>
                            <div className="card p-6 flex items-center gap-5">
                                ...
                                <div>
                                    <h4 className="text-base font-bold text-[var(--text-heading)]" style={{ fontFamily: 'Outfit, sans-serif' }}>
                                        {t.about.ceo}
                                    </h4>
                                ...
                                <div className="space-y-4">
                                    {registryItems.map((item, i) => (
                                        <div key={i} className="flex items-center gap-4">
                                            ...
                                            >
                                                <item.icon size={16} className="text-[var(--royal-light)]" />
                                            </div>
                                                    <div>
