            ...
            <div className="max-w-7xl mx-auto px-6 pt-20 pb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-1">
                        <div className="flex items-center gap-3 mb-5">
                            ...
                            />
                            <div>
                                <div className="font-bold text-white text-sm" style={{ fontFamily: 'Outfit, sans-serif' }}>
                                    R&B Rajh Holding AG
                                </div>
                        ...
                        <div className="flex items-center gap-2 text-xs text-white/30">
                            ...
                            <span className="tracking-widest uppercase font-semibold">Est. 2019</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3 text-sm text-white/50">
                            ...
                            <p className="pt-1">
                                <a href="mailto:info@rbrajhholding.ch" className="hover:text-white transition-colors">
                                    info@rbrajhholding.ch
                                </a>
                            </p>
                            <p>
                                <a href="tel:+41345305040" className="hover:text-white transition-colors">
                                    +41 34 530 50 40
                                </a>
                            </p>
                        </div>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <p className="text-xs text-white/30">
                        &copy; {new Date().getFullYear()} R&B Rajh Holding AG. {t.footer.rights}
                    </p>
                    <button
                        onClick={scrollToTop}
