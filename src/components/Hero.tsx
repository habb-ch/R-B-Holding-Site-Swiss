...
export default function Hero({ locale }: HeroProps) {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-[var(--off-white)] via-white to-[var(--light-bg)]"
    >
      {/* Decorative blobs */}
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-56 h-56 rounded-3xl bg-white border border-[var(--border-light)] shadow-lg flex items-center justify-center rotate-6 hover:rotate-0 transition-transform duration-700">
                    <div className="text-center">
                      <div
                        className="text-5xl font-black text-[var(--navy)]"
                        style={{ fontFamily: "Outfit, sans-serif" }}
                      >
                        R&B
                      </div>
                      <div className="h-0.5 w-12 mx-auto mt-2 mb-2 bg-[var(--gold)] rounded-full" />
                      <div className="text-sm font-semibold text-[var(--text-muted)] tracking-widest uppercase">
                        Holding AG
                      </div>
                    </div>
                  </div>
